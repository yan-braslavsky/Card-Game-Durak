 ...
 */
public class ChildButtonNode extends YANButtonNode {

    private final UniformlyParentedNodeComponent mComp;

    public ChildButtonNode(YANAtlasTextureRegion defaultTextureRegion, YANAtlasTextureRegion pressedTextureRegion) {
        super(defaultTextureRegion, pressedTextureRegion);
